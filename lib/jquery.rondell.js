    ...
    */
    ...
    Rondell = (function() {
      ...
      Rondell.prototype._initItem = function(layerNum, item) {
        ...
        if (item.object[0].nodeName.toLowerCase() === "img") {
    ...
    return $.rondell.presets = {
      ...
      thumbGallery: {
        ...
        funcTop: function(l, r, i) {
          if (i > r._focusedItem.currentSlot) i--;
          return r.special.itemPadding + Math.floor(((i - 1) % r.special.groupSize) / r.special.rows) * (r.itemProperties.size.height + r.special.itemPadding);
        },
        funcLeft: function(l, r, i) {
          ...
          return 500 + r.special.itemPadding + (column + r.special.columns * groupOffset) * (r.itemProperties.size.width + r.special.itemPadding);
        }
      },
      slider: {
        visibleItems: 1,
