...
(function($) {
  ...
  Rondell = (function() {
    ...
    Rondell.prototype._initItem = function(layerNum, item) {
      ...
      return item.object.addClass("new " + this.itemProperties.cssClass).css('opacity', 0).bind('mouseover mouseout click', __bind(function(e) {
        switch (e.type) {
          case 'mouseover':
    ...
    Rondell.prototype.layerFadeIn = function(layerNum) {
      ...
      item.object.stop(true).show(0).animate({
    ...
    Rondell.prototype.layerFadeOut = function(layerNum) {
      var fadeTime, item, layerDiff, layerDist, layerPos, margin, newOpacity, newX, newY, newZ;
      item = this._getItem(layerNum);
      ...
      if (layerDist <= this.visibleItems || item.object.hasClass('new')) {
        ...
        return item.object.stop(true).css('z-index', newZ).animate({
          ...
          top: newY,
          opacity: 0
        }, fadeTime, this.funcEase, __bind(function() {}, this), this.hideCaption(layerNum));
      }
    };
