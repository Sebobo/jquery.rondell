...
/*!
    ...
    @license Licensed under the MIT (http://www.opensource.org/licenses/mit-license.php) license.
  */
(function(b){b.rondell=b.rondell||{};return b.rondell.presets={carousel:{autoRotation:{enabled:true,direction:1,once:false,delay:5000},radius:{x:220},controls:{margin:{x:20,y:190}},currentLayer:1,funcSize:function(d,c){return(c.maxItems/Math.abs(d))/c.maxItems}},products:{repeating:false,alwaysShowCaption:true,visibleItems:4,itemProperties:{delay:0,size:{width:100,height:200},sizeFocused:{width:300,height:200}},center:{left:400,top:100},controls:{margin:{x:210,y:158}},funcTop:function(d,c){return 0},funcDiff:function(d,c){return Math.abs(d)+1},funcLeft:function(d,c){return c.center.left+(d-0.5)*c.itemProperties.size.width},funcOpacity:function(d,c){return 0.8}},pages:{radius:{x:0,y:0},scaling:1,visibleItems:1,controls:{enabled:false},center:{left:200,top:200},itemProperties:{size:{width:400,height:400}},funcTop:function(d,c){return c.center.top-c.itemProperties.size.height/2},funcLeft:function(d,c){return c.center.left+d*c.itemProperties.size.width},funcDiff:function(d,c){return Math.abs(d)+0.5}},cubic:{center:{left:400,top:200},visibleItems:5,itemProperties:{size:{width:350,height:350},sizeFocused:{width:350,height:350}},controls:{margin:{x:10,y:190}},funcTop:function(d,c){return c.center.top-c.itemProperties.size.height/2+Math.pow(d/2,3)*c.radius.x},funcLeft:function(d,c){return c.center.left-c.itemProperties.size.width/2+Math.sin(d)*c.radius.x},funcSize:function(d,c){return Math.pow((Math.PI-Math.abs(d))/Math.PI,3)}},gallery:{visibleItems:4,controls:{enabled:false},center:{top:145,left:250},size:{height:400,width:500},itemProperties:{delay:10,sizeFocused:{width:480,height:280},size:{width:100,height:100}},funcTop:function(d,c){return c.size.height-c.itemProperties.size.height-5},funcDiff:function(d,c){return Math.abs(d)-0.5},funcLeft:function(d,c){return c.center.left+(d-0.5)*(c.itemProperties.size.width+5)},funcOpacity:function(d,c){return 0.8}}}})(jQuery)}).call(this);